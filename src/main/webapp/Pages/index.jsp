...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="../css/home_assets/bootstrap/css/bootstrap.min.css?h=a4a4b4ec2caaeea34fdeabb9e8eaf2dd"
    />
    <link
      rel="stylesheet"
    ...
    <link
      rel="stylesheet"
      href="../css/home_assets/css/styles.min.css?h=6677ea1bbff535befea0f9bbf0c6088a"
    />
  ...
  >
    ...
    <header
      class="masthead"
      style="
        background-image: url('../css/home_assets/img/intro-bg.jpg?h=145cae4a8124ee5dac950230c1552d3c');
      "
    >
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <button class="button navbar-toggler navbar-toggler-right"> <a href="signin.jsp" style="text-decoration:none;color:white">Login</a></button>
              <button class="button navbar-toggler navbar-toggler-right"> <a href="SignUp.jsp" style="text-decoration:none;color:white">Register</a></button>
            </div>
          </div>
        </div>
      </div>
    ...
    <section
      ...
      id="download"
      style="
        background-image: url('../css/home_assets/img/downloads-bg.jpg?h=a1c980f5883ce005385e0ccdc3919d4c');
        padding-top: 60px;
        padding-bottom: 50px;
      "
    >
    ...
    <script src="../css/home_assets/js/script.min.js?h=abade7a6b58120c54533d461e48e360b"></script>
  </body>
</html>
